					  ...
					  <ul>
					   <li>Software Wallet
						<ul>
						 ...
						 <li>Pro: Automated rewards payouts to delegators</li>
					   ...
					   <li>Ledger Device
						<ul>
						 ...
						 <li>Con: No automated rewards; must physically process rewards</li>
