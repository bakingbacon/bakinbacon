...
func TestProofOfWork(t *testing.T) {
	...
	networkConstants, err := util.GetNetworkConstants(util.NETWORK_HANGZHOUNET)
	if err != nil {
		t.Errorf("Cannot load network constants")
	}

	s := BakinBacon{NetworkConstants: networkConstants}
